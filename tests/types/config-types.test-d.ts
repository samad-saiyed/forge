...
export const checkConfigType: AssertEqual<typeof config, KyuuConfigInput> = true;

// 2. Check explicit input type assignments
const explicitInput: KyuuConfigInput = {
...
export const checkExplicitInput: AssertEqual<typeof explicitInput, KyuuConfigInput> = true;
void explicitInput;

// 3. Check resolveConfig return type
const resolved = resolveConfig(config);
export const checkResolvedType: AssertEqual<typeof resolved, ResolvedKyuuConfig> = true;

// 4. Check property access on ResolvedKyuuConfig
